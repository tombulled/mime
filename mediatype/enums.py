...
class MediaTypeSubtype(KebabEnum):
    ...
    VND_3GPP_V2X_LOCAL_SERVICE_INFORMATION: str = (
    ...
    VND_ANSER_WEB_CERTIFICATE_ISSUE_INITIATION: str = (
    ...
    VND_COLLABIO_XODOCUMENTS_DOCUMENT_TEMPLATE: str = (
    ...
    VND_COLLABIO_XODOCUMENTS_PRESENTATION_TEMPLATE: str = (
    ...
    VND_COLLABIO_XODOCUMENTS_SPREADSHEET_TEMPLATE: str = (
    ...
    VND_DOREMIR_SCORECLOUD_BINARY_DOCUMENT: str = (
    ...
    VND_DVB_NOTIF_IA_REGISTRATION_RESPONSE: str = (
    ...
    VND_ETSI_OVERLOAD_CONTROL_POLICY_DATASET: str = (
    ...
    VND_GLOBALPLATFORM_CARD_CONTENT_MGT_RESPONSE: str = (
    ...
    VND_LLAMAGRAPHICS_LIFE_BALANCE_DESKTOP: str = (
        "vnd.llamagraphics.life-balance.desktop"
    )
    VND_LLAMAGRAPHICS_LIFE_BALANCE_EXCHANGE: str = (
    ...
    VND_MS_EXCEL_SHEET_BINARY_MACROENABLED_12: str = (
    ...
    VND_MS_POWERPOINT_ADDIN_MACROENABLED_12: str = (
        "vnd.ms-powerpoint.addin.macroenabled.12"
    )
    VND_MS_POWERPOINT_PRESENTATION_MACROENABLED_12: str = (
        "vnd.ms-powerpoint.presentation.macroenabled.12"
    )
    VND_MS_POWERPOINT_SLIDE_MACROENABLED_12: str = (
        "vnd.ms-powerpoint.slide.macroenabled.12"
    )
    VND_MS_POWERPOINT_SLIDESHOW_MACROENABLED_12: str = (
        "vnd.ms-powerpoint.slideshow.macroenabled.12"
    )
    VND_MS_POWERPOINT_TEMPLATE_MACROENABLED_12: str = (
    ...
    VND_OASIS_OPENDOCUMENT_PRESENTATION_TEMPLATE: str = (
        "vnd.oasis.opendocument.presentation-template"
    )
    VND_OASIS_OPENDOCUMENT_SPREADSHEET: str = "vnd.oasis.opendocument.spreadsheet"
    VND_OASIS_OPENDOCUMENT_SPREADSHEET_TEMPLATE: str = (
    ...
    VND_OMA_BCAST_ASSOCIATED_PROCEDURE_PARAMETER: str = (
    ...
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_CUSTOM_PROPERTIES: str = (
        "vnd.openxmlformats-officedocument.custom-properties"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_CUSTOMXMLPROPERTIES: str = (
        "vnd.openxmlformats-officedocument.customxmlproperties"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_DRAWING: str = (
        "vnd.openxmlformats-officedocument.drawing"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_DRAWINGML_CHART: str = (
        "vnd.openxmlformats-officedocument.drawingml.chart"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_DRAWINGML_CHARTSHAPES: str = (
        "vnd.openxmlformats-officedocument.drawingml.chartshapes"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_DRAWINGML_DIAGRAMCOLORS: str = (
        "vnd.openxmlformats-officedocument.drawingml.diagramcolors"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_DRAWINGML_DIAGRAMDATA: str = (
        "vnd.openxmlformats-officedocument.drawingml.diagramdata"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_DRAWINGML_DIAGRAMLAYOUT: str = (
        "vnd.openxmlformats-officedocument.drawingml.diagramlayout"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_DRAWINGML_DIAGRAMSTYLE: str = (
        "vnd.openxmlformats-officedocument.drawingml.diagramstyle"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_EXTENDED_PROPERTIES: str = (
        "vnd.openxmlformats-officedocument.extended-properties"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_PRESENTATIONML_COMMENTAUTHORS: str = (
        "vnd.openxmlformats-officedocument.presentationml.commentauthors"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_PRESENTATIONML_COMMENTS: str = (
        "vnd.openxmlformats-officedocument.presentationml.comments"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_PRESENTATIONML_HANDOUTMASTER: str = (
        "vnd.openxmlformats-officedocument.presentationml.handoutmaster"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_PRESENTATIONML_NOTESMASTER: str = (
        "vnd.openxmlformats-officedocument.presentationml.notesmaster"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_PRESENTATIONML_NOTESSLIDE: str = (
        "vnd.openxmlformats-officedocument.presentationml.notesslide"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_PRESENTATIONML_PRESENTATION: str = (
        "vnd.openxmlformats-officedocument.presentationml.presentation"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_PRESENTATIONML_PRESENTATION_MAIN: str = (
        "vnd.openxmlformats-officedocument.presentationml.presentation.main"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_PRESENTATIONML_PRESPROPS: str = (
        "vnd.openxmlformats-officedocument.presentationml.presprops"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_PRESENTATIONML_SLIDE: str = (
        "vnd.openxmlformats-officedocument.presentationml.slide"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_PRESENTATIONML_SLIDELAYOUT: str = (
        "vnd.openxmlformats-officedocument.presentationml.slidelayout"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_PRESENTATIONML_SLIDEMASTER: str = (
        "vnd.openxmlformats-officedocument.presentationml.slidemaster"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_PRESENTATIONML_SLIDESHOW: str = (
        "vnd.openxmlformats-officedocument.presentationml.slideshow"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_PRESENTATIONML_SLIDESHOW_MAIN: str = (
        "vnd.openxmlformats-officedocument.presentationml.slideshow.main"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_PRESENTATIONML_SLIDEUPDATEINFO: str = (
        "vnd.openxmlformats-officedocument.presentationml.slideupdateinfo"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_PRESENTATIONML_TABLESTYLES: str = (
        "vnd.openxmlformats-officedocument.presentationml.tablestyles"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_PRESENTATIONML_TAGS: str = (
        "vnd.openxmlformats-officedocument.presentationml.tags"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_PRESENTATIONML_TEMPLATE: str = (
        "vnd.openxmlformats-officedocument.presentationml.template"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_PRESENTATIONML_TEMPLATE_MAIN: str = (
        "vnd.openxmlformats-officedocument.presentationml.template.main"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_PRESENTATIONML_VIEWPROPS: str = (
        "vnd.openxmlformats-officedocument.presentationml.viewprops"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_SPREADSHEETML_CALCCHAIN: str = (
        "vnd.openxmlformats-officedocument.spreadsheetml.calcchain"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_SPREADSHEETML_CHARTSHEET: str = (
        "vnd.openxmlformats-officedocument.spreadsheetml.chartsheet"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_SPREADSHEETML_COMMENTS: str = (
        "vnd.openxmlformats-officedocument.spreadsheetml.comments"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_SPREADSHEETML_CONNECTIONS: str = (
        "vnd.openxmlformats-officedocument.spreadsheetml.connections"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_SPREADSHEETML_DIALOGSHEET: str = (
        "vnd.openxmlformats-officedocument.spreadsheetml.dialogsheet"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_SPREADSHEETML_EXTERNALLINK: str = (
        "vnd.openxmlformats-officedocument.spreadsheetml.externallink"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_SPREADSHEETML_PIVOTCACHEDEFINITION: str = (
        "vnd.openxmlformats-officedocument.spreadsheetml.pivotcachedefinition"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_SPREADSHEETML_PIVOTCACHERECORDS: str = (
        "vnd.openxmlformats-officedocument.spreadsheetml.pivotcacherecords"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_SPREADSHEETML_PIVOTTABLE: str = (
        "vnd.openxmlformats-officedocument.spreadsheetml.pivottable"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_SPREADSHEETML_QUERYTABLE: str = (
        "vnd.openxmlformats-officedocument.spreadsheetml.querytable"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_SPREADSHEETML_REVISIONHEADERS: str = (
        "vnd.openxmlformats-officedocument.spreadsheetml.revisionheaders"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_SPREADSHEETML_REVISIONLOG: str = (
        "vnd.openxmlformats-officedocument.spreadsheetml.revisionlog"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_SPREADSHEETML_SHAREDSTRINGS: str = (
        "vnd.openxmlformats-officedocument.spreadsheetml.sharedstrings"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_SPREADSHEETML_SHEET: str = (
        "vnd.openxmlformats-officedocument.spreadsheetml.sheet"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_SPREADSHEETML_SHEET_MAIN: str = (
        "vnd.openxmlformats-officedocument.spreadsheetml.sheet.main"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_SPREADSHEETML_SHEETMETADATA: str = (
        "vnd.openxmlformats-officedocument.spreadsheetml.sheetmetadata"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_SPREADSHEETML_STYLES: str = (
        "vnd.openxmlformats-officedocument.spreadsheetml.styles"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_SPREADSHEETML_TABLE: str = (
        "vnd.openxmlformats-officedocument.spreadsheetml.table"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_SPREADSHEETML_TABLESINGLECELLS: str = (
        "vnd.openxmlformats-officedocument.spreadsheetml.tablesinglecells"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_SPREADSHEETML_TEMPLATE: str = (
        "vnd.openxmlformats-officedocument.spreadsheetml.template"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_SPREADSHEETML_TEMPLATE_MAIN: str = (
        "vnd.openxmlformats-officedocument.spreadsheetml.template.main"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_SPREADSHEETML_USERNAMES: str = (
        "vnd.openxmlformats-officedocument.spreadsheetml.usernames"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_SPREADSHEETML_VOLATILEDEPENDENCIES: str = (
        "vnd.openxmlformats-officedocument.spreadsheetml.volatiledependencies"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_SPREADSHEETML_WORKSHEET: str = (
        "vnd.openxmlformats-officedocument.spreadsheetml.worksheet"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_THEME: str = (
        "vnd.openxmlformats-officedocument.theme"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_THEMEOVERRIDE: str = (
        "vnd.openxmlformats-officedocument.themeoverride"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_VMLDRAWING: str = (
        "vnd.openxmlformats-officedocument.vmldrawing"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_WORDPROCESSINGML_COMMENTS: str = (
        "vnd.openxmlformats-officedocument.wordprocessingml.comments"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_WORDPROCESSINGML_DOCUMENT: str = (
        "vnd.openxmlformats-officedocument.wordprocessingml.document"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_WORDPROCESSINGML_DOCUMENT_GLOSSARY: str = (
        "vnd.openxmlformats-officedocument.wordprocessingml.document.glossary"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_WORDPROCESSINGML_DOCUMENT_MAIN: str = (
        "vnd.openxmlformats-officedocument.wordprocessingml.document.main"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_WORDPROCESSINGML_ENDNOTES: str = (
        "vnd.openxmlformats-officedocument.wordprocessingml.endnotes"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_WORDPROCESSINGML_FONTTABLE: str = (
        "vnd.openxmlformats-officedocument.wordprocessingml.fonttable"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_WORDPROCESSINGML_FOOTER: str = (
        "vnd.openxmlformats-officedocument.wordprocessingml.footer"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_WORDPROCESSINGML_FOOTNOTES: str = (
        "vnd.openxmlformats-officedocument.wordprocessingml.footnotes"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_WORDPROCESSINGML_NUMBERING: str = (
        "vnd.openxmlformats-officedocument.wordprocessingml.numbering"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_WORDPROCESSINGML_SETTINGS: str = (
        "vnd.openxmlformats-officedocument.wordprocessingml.settings"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_WORDPROCESSINGML_STYLES: str = (
        "vnd.openxmlformats-officedocument.wordprocessingml.styles"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_WORDPROCESSINGML_TEMPLATE: str = (
        "vnd.openxmlformats-officedocument.wordprocessingml.template"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_WORDPROCESSINGML_TEMPLATE_MAIN: str = (
        "vnd.openxmlformats-officedocument.wordprocessingml.template.main"
    )
    VND_OPENXMLFORMATS_OFFICEDOCUMENT_WORDPROCESSINGML_WEBSETTINGS: str = (
        "vnd.openxmlformats-officedocument.wordprocessingml.websettings"
    )
    VND_OPENXMLFORMATS_PACKAGE_CORE_PROPERTIES: str = (
        "vnd.openxmlformats-package.core-properties"
    )
    VND_OPENXMLFORMATS_PACKAGE_DIGITAL_SIGNATURE_XMLSIGNATURE: str = (
        "vnd.openxmlformats-package.digital-signature-xmlsignature"
    )
    VND_OPENXMLFORMATS_PACKAGE_RELATIONSHIPS: str = (
